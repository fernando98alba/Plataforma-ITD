...
class PerfilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference("Perfil.count") do
      post perfils_url, params: { perfil: { date_birth: @perfil.date_birth, email: @perfil.email, first_name: @perfil.first_name, last_name: @perfil.last_name } }
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { date_birth: @perfil.date_birth, email: @perfil.email, first_name: @perfil.first_name, last_name: @perfil.last_name } }
